...
const quo = document.querySelector("#quot span:first-child");
const aut = document.querySelector("#quot span:last-child");

const inde = Math.floor(Math.random()*quotes.length);

quo.innerText = quotes[inde].quote;
aut.innerText = quotes[inde].author;
